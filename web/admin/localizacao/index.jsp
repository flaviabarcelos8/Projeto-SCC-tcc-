...
<div class="content">
    <form action="LocalizacaoWS" method="get" class="form-horizontal">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-primary" href="LocalizacaoWS?acao=edit&id=${obj.id}" role="button">Editar
                                        
                             </a>
                        </td>
                        <td><a class="btn btn-primary" href="LocalizacaoWS?acao=del&id=${obj.id}" role="button">Excluir
