                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>${obj.cargo}</td>
                        <td>
                          <a class="btn btn-info btn-fab btn-icon btn-round" href="CargoWS?acao=edit&id=${obj.id}">
                                        <i class="nc-icon tim-icons icon-pencil"></i>
                             </a>
                        </td>
                        <td><a class="btn btn-info btn-fab btn-icon btn-round" href="CargoWS?acao=del&id=${obj.id}">
