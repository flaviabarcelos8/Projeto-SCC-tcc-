                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>${obj.topico}</td>
                        <td>
                          <a class="btn btn-info btn-fab btn-icon btn-round" href="TopicoWS?acao=edit&id=${obj.id}">
                                        <i class="nc-icon tim-icons icon-pencil"></i>
                             </a>
                        </td>
                        <td><a class="btn btn-info btn-fab btn-icon btn-round" href="TopicoWS?acao=del&id=${obj.id}">
